...
/**
    ...
    public void create() throws Exception {
        Doctor doctor = DoctorFactory.buildDoctor(values, "12");
        service.save(doctor);
    ...
    public void read() throws Exception {
        Doctor readDoctor = service.findById("12");
    ...
    public void update() throws Exception {
        ...
        Doctor newDoctor = new Doctor.Builder()
                ...
                .build();
        service.update("12");
        Doctor updatedDoctor = service.findById("12");
    ...
    public void delete() throws Exception {
        service.delete("12");
        Doctor doctor = service.findById("12");
        assertNull(doctor);
    }*/
}
